      ...
      <div class="row max-height justify-content-center align-items-center">
        ...
        <div id="cart" class="cart">
          ...
          <div class="cart-item d-flex justify-content-between text-capitalize my-3">
            <img src="img/cake-2.jpeg" class="img-fluid rounded-circle" id="item-img" alt="" width="50" height="50">
            <div class="item-text">
          ...
          <!-- cart item -->
         <!-- <div class="cart-item d-flex justify-content-between text-capitalize my-3">
            <img src="img/doughnut-2.jpeg" class="img-fluid rounded-circle" id="item-img" alt="" width="50" height="50">
